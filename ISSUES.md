...
> Last updated: 2026-08-23. All 62 originally logged issues, regressions R1–R8, high-severity bugs H1–H9, and performance optimizations have been fixed, refactored, and covered by unit tests.
...
| **Regressions & Residuals (R1–R8, H1–H9, M5–M6)** | 18 | **RESOLVED** | Process termination, safe cover isolation, symbol hotkey mappings, multi-file playlist stats/sleep timer, independent `FlyoutController` anchoring. |
...
- **Input Conflict Prevention (H8)**: Bare in-app hotkeys (e.g. Space, Escape, Arrows) check for focused `EditableText` before triggering playback or navigation actions.
